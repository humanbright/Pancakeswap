    ...
    return (
      <AutoColumn gap="md">
        <RowBetween align="flex-end">
          <Text color="white" fontSize="24px">{parsedAmounts[Field.CURRENCY_A]?.toSignificant(6)}</Text>
          <RowFixed gap="4px">
            <CurrencyLogo currency={currencyA} size="24px" />
            <Text color="white" fontSize="24px" ml="10px">
              {currencyA?.symbol}
            </Text>
          </RowFixed>
        </RowBetween>
        ...
        <RowBetween align="flex-end">
          <Text color="white" fontSize="24px">{parsedAmounts[Field.CURRENCY_B]?.toSignificant(6)}</Text>
          <RowFixed gap="4px">
        ...
        <Text color="white" small textAlign="left" pt="12px">
