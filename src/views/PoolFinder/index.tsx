      ...
      <AppBody>
        ...
        <AutoColumn style={{ padding: '1rem' }} gap="md">
          ...
          {hasPosition && (
            ...
            >
              <Text color="white" textAlign="center">{t('Pool Found!')}</Text>
              <StyledInternalLink to="/pool">
                <Text color="white" textAlign="center">{t('Manage this pool.')}</Text>
              </StyledInternalLink>
            </ColumnCenter>
          )}
          ...
          {currency0 && currency1 ? (
            pairState === PairState.EXISTS ? (
              hasPosition && pair ? (
                ...
                <LightCard padding="45px 10px">
                  <AutoColumn gap="sm" justify="center">
                    <Text color="white" textAlign="center">{t('You don’t have liquidity in this pool yet.')}</Text>
                    <StyledInternalLink to={`/add/${currencyId(currency0)}/${currencyId(currency1)}`}>
                      <Text color="white" textAlign="center">{t('Add Liquidity')}</Text>
                    </StyledInternalLink>
                  </AutoColumn>
                </LightCard>
              )
              ...
              <LightCard padding="45px 10px">
                <AutoColumn gap="sm" justify="center">
                  <Text color="white" textAlign="center">{t('No pool found.')}</Text>
                  <StyledInternalLink to={`/add/${currencyId(currency0)}/${currencyId(currency1)}`}>
                    {t('Create pool.')}
                  </StyledInternalLink>
                </AutoColumn>
