    ...
    <>
      <SwapModalFooterContainer>
        <RowBetween align="center">
          <Text color="white" fontSize="14px">Price</Text>
          <Text color="white"
            fontSize="14px"
            style={{
          ...
          >
            ...
            <StyledBalanceMaxMini onClick={() => setShowInverted(!showInverted)}>
              <AutoRenewIcon color="white" width="14px" />
        ...
        <RowBetween>
          ...
          <RowFixed>
            ...
            <Text color="white" fontSize="14px" marginLeft="4px">
              {trade.tradeType === TradeType.EXACT_INPUT
        ...
        <RowBetween>
          <RowFixed>
            <Text color="white" fontSize="14px">Price Impact</Text>
        ...
        <RowBetween>
          <RowFixed>
            <Text color="white" fontSize="14px">Liquidity Provider Fee</Text>
            <QuestionHelper
              text={
                <>
