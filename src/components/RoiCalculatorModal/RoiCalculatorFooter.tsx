...
const RoiCalculatorFooter: React.FC<RoiCalculatorFooterProps> = ({
  ...
  const {
    ...
    <>
      <Text>
        {t(
          'The Multiplier represents the proportion of PUM rewards each farm receives, as a proportion of the PUM produced each block.',
        )}
      </Text>
      <Text my="24px">
        {t('For example, if a 1x farm received 1 PUM per block, a 100x farm would receive 100 PUM per block.')}
      </Text>
      ...
      {isExpanded && (
        <Box px="8px">
          <Grid gridTemplateColumns="2.5fr 1fr" gridRowGap="8px" gridTemplateRows={`repeat(${gridRowCount}, auto)`}>
            ...
            <Text color="#280D5F" small>
              {isFarm ? t('Base APR (PUM yield only)') : t('APR')}
            </Text>
            <Text small textAlign="right">
              {apr.toFixed(2)}%
            </Text>
              ...
              <>
                ...
                <Flex justifyContent="flex-end" alignItems="flex-end">
                  ...
                  <span ref={multiplierRef}>
                    <HelpIcon color="#280D5F" width="16px" height="16px" />
                  </span>
          ...
          <BulletList>
            <li>
              <Text fontSize="12px" textAlign="center" color="#280D5F" display="inline">
            ...
            {performanceFee > 0 && (
              <li>
                <Text mt="14px" fontSize="12px" textAlign="center" color="#280D5F" display="inline">
